...
import { TrendingUp, TrendingDown, ThumbsUp, Download, Users, Calendar, Umbrella, DollarSign, FileText, MessageSquare, BarChart3, Layers, Shield, FileCheck, User, Image, Menu, X } from 'lucide-react';
...
const Index = () => {
  ...
  const stats = [
    { value: '348', label: 'Users', icon: Users, color: 'from-orange-400 to-red-400', rotation: 45 },
    { value: '128', label: 'Events', icon: Calendar, color: 'from-blue-400 to-blue-500', rotation: -45 },
    { value: '10', label: 'Holidays', icon: Umbrella, color: 'from-yellow-400 to-orange-400', rotation: 45 },
    { value: '3458', label: 'Payrolls', icon: DollarSign, color: 'from-green-400 to-emerald-400', rotation: -45 },
    { value: '3488', label: 'Reports', icon: FileText, color: 'from-purple-400 to-pink-400', rotation: 45 },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-3 sm:p-6">
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-full w-20 bg-gray-900 shadow-2xl flex flex-col items-center py-6 space-y-6 border-r border-gray-800 z-40 transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
    ...
    <img src={logo} alt="Logo" className="w-12 h-12 rounded-full" />
        ...
        {sidebarIcons.map((item, i) => {
          ...
          return (
            <div key={i} className={`w-10 h-10 rounded-lg bg-gradient-to-br ${i === 0 ? 'from-red-600 to-red-700' : 'from-gray-700 to-gray-800'} flex items-center justify-center hover:scale-110 cursor-pointer transition-transform shadow-md`}>
      ...
      <div className="lg:ml-24 lg:mr-4">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-6 sm:mb-8 space-y-4 lg:space-y-0 pt-16 lg:pt-0">
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">Hello Admin!</h1>
            <p className="text-gray-400 text-xs sm:text-sm">Measure How Fast You're Growing Monthly Recurring<br className="hidden sm:block"/>performance management.</p>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-2 lg:space-x-4">
            ...
            <div className="flex items-center space-x-3 self-end sm:self-auto">
              ...
              <div className="relative">
                ...
                <span className="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-red-600 rounded-full text-white text-xs flex items-center justify-center">2</span>
              </div>
              <div className="relative">
                <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gray-700 rounded-full"></div>
                <span className="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-red-600 rounded-full text-white text-xs flex items-center justify-center">2</span>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 mb-6">
            {stats.map((stat, idx) => (
              <div key={idx} className="bg-gray-800 border border-gray-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-shadow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
          ...
          <div className="lg:col-span-2 bg-gray-800 border border-gray-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
            <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6">
              <div className="flex items-center space-x-2 sm:space-x-4">
                <h3 className="text-base sm:text-lg font-bold text-white">Salary Statistics</h3>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 lg:space-x-6">
                <div className="text-xs hidden lg:block">
                  ...
                  <div className="text-gray-400">Marketing: 2437 Design: 7689</div>
                  <div className="text-gray-400">Development: 7689 Others: 7688</div>
                </div>
            ...
            <div className="h-48 sm:h-56 lg:h-64 relative">
              ...
              <svg className="w-full h-full pl-8" viewBox="0 0 800 250" preserveAspectRatio="none">
                {/* Grid lines */}
                <line x1="50" y1="50" x2="750" y2="50" stroke="#374151" strokeWidth="1"/>
                <line x1="50" y1="100" x2="750" y2="100" stroke="#374151" strokeWidth="1"/>
                <line x1="50" y1="150" x2="750" y2="150" stroke="#374151" strokeWidth="1"/>
                <line x1="50" y1="200" x2="750" y2="200" stroke="#374151" strokeWidth="1"/>
                
                {/* Gray line (Others) */}
                <path d="M 50 150 Q 100 170, 150 160 Q 200 145, 250 155 Q 300 165, 350 145 Q 400 130, 450 140 Q 500 155, 550 135 Q 600 120, 650 130 Q 700 145, 750 140" 
                      fill="none" stroke="#6b7280" strokeWidth="3" strokeLinecap="round"/>
                
                {/* White line (Development) */}
                <path d="M 50 120 Q 100 110, 150 125 Q 200 135, 250 120 Q 300 105, 350 115 Q 400 125, 450 110 Q 500 100, 550 115 Q 600 130, 650 120 Q 700 110, 750 125" 
                      fill="none" stroke="#f3f4f6" strokeWidth="3" strokeLinecap="round"/>
                
                {/* Red line (Marketing) with highlighted point */}
                <path d="M 50 170 Q 100 160, 150 145 Q 200 130, 250 115 Q 300 95, 350 80 Q 400 70, 450 85 Q 500 105, 550 95 Q 600 85, 650 100 Q 700 115, 750 105" 
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
            <div className="flex justify-between items-center mb-4 sm:mb-6">
              <h3 className="text-base sm:text-lg font-bold text-white">Employee Satisfaction</h3>
            ...
            <div className="flex items-center justify-center h-48 sm:h-56 lg:h-64">
              <div className="relative w-40 h-40 sm:w-48 sm:h-48">
                <svg className="w-full h-full transform -rotate-90">
                  <circle cx="80" cy="80" r="65" fill="none" stroke="#374151" strokeWidth="16" className="sm:hidden"/>
                  <circle cx="80" cy="80" r="65" fill="none" stroke="#ef4444" strokeWidth="16"
                          strokeDasharray="408" strokeDashoffset="106" strokeLinecap="round" className="sm:hidden"/>
                  <circle cx="96" cy="96" r="80" fill="none" stroke="#374151" strokeWidth="20" className="hidden sm:block"/>
                  <circle cx="96" cy="96" r="80" fill="none" stroke="#ef4444" strokeWidth="20"
                          strokeDasharray="502" strokeDashoffset="130" strokeLinecap="round" className="hidden sm:block"/>
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <ThumbsUp className="w-6 h-6 sm:w-8 sm:h-8 text-gray-500 mb-2" />
                  <div className="text-3xl sm:text-4xl font-bold text-white">74%</div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
            <div className="flex justify-between items-center mb-4 sm:mb-6">
              <h3 className="text-base sm:text-lg font-bold text-white">Performance Statistics</h3>
              <button className="p-2 hover:bg-gray-700 rounded-lg">
                <Download className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
              </button>
            </div>
              ...
              {performanceData.map((item, idx) => (
                <div key={idx}>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-xs sm:text-sm text-gray-400">{item.team}</span>
                    <span className="text-xs sm:text-sm font-bold text-white">{item.percentage}%</span>
                  </div>
                  <div className="w-full h-2 bg-gray-700 rounded-full overflow-hidden">
                    <div className={`h-full ${idx === 0 ? 'bg-red-500' : idx === 1 ? 'bg-red-400' : 'bg-gray-600'} rounded-full`} 
          ...
          <div className="lg:col-span-2 bg-gray-800 border border-gray-700 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <div className="text-xs">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-red-600 to-red-700 flex items-center justify-center text-white text-xs font-bold">28%</div>
                  </div>
            ...
            <div className="h-40 sm:h-44 lg:h-48 relative">
              ...
              <svg className="w-full h-full pl-6" viewBox="0 0 900 200">
                {/* Grid lines */}
                <line x1="50" y1="40" x2="850" y2="40" stroke="#374151" strokeWidth="1"/>
                <line x1="50" y1="90" x2="850" y2="90" stroke="#374151" strokeWidth="1"/>
                <line x1="50" y1="140" x2="850" y2="140" stroke="#374151" strokeWidth="1"/>
                ...
                {[
                  ...
                  { year: '2014', x: 460, male: 110, female: 60, highlight: true },
                  { year: '', x: 510, male: 80, female: 120 },
                  { year: '2015', x: 560, male: 120, female: 80, highlight: true },
                  { year: '', x: 610, male: 60, female: 100 },
                  { year: '2016', x: 660, male: 100, female: 90, highlight: true },
                  ...
                  <g key={i}>
                    ...
                    <defs>
                      <linearGradient id={`maleGrad${i}`} x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stopColor={data.highlight ? "#ef4444" : "#4b5563"} stopOpacity="0.9"/>
                        <stop offset="100%" stopColor={data.highlight ? "#dc2626" : "#374151"} stopOpacity="0.6"/>
                      </linearGradient>
                      <linearGradient id={`femaleGrad${i}`} x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stopColor="#6b7280" stopOpacity="0.7"/>
                        <stop offset="100%" stopColor="#4b5563" stopOpacity="0.4"/>
                      </linearGradient>
                    </defs>
                    <rect x={data.x} y={180 - data.male} width="18" height={data.male} 
                          fill={`url(#maleGrad${i})`} rx="9"/>
                    <rect x={data.x + 22} y={180 - data.female} width="18" height={data.female} 
                          fill={`url(#femaleGrad${i})`} rx="9"/>
                  </g>
                ))}
                
                {/* Dotted trend line */}
                <path d="M 70 110 L 170 95 L 270 105 L 370 90 L 470 70 L 570 85 L 670 80 L 770 100" 
